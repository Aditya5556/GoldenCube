...
def create_data_frame():
    ...
    Asset1 = [2.75, -1.50, 3.20, 0.85, -3.10, 1.60, 4.90, -0.75, 5.25, -2.40, 1.95]
    Asset2 = [-2.10, 1.35, -0.85, 3.40, -1.20, 0.65, 4.50, -2.19, 1.89, -0.70, 2.55]
    Asset3 = [-1.25, 0.85, 1.50, 2.10, -0.65, 3.25, 1.80, -0.90, 4.50, -2.10, 1.35]
    Asset4 = [0.25, 0.40, 0.15, 0.75, -0.20, 0.60, 0.85, 0.30, 1.10, -0.10, 0.50]
